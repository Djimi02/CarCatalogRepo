...
public interface CarRepository extends JpaRepository<Car, Long> {
    ...
    @Query(value = "SELECT c.id, c.price, c.remarks, c.vin_number, c.fuel_type_id, c.model_id, c.transmission_id " + 
                    ...
                    "(c.price <= :price OR :price is null) " +
                    "ORDER BY c.price DESC", nativeQuery = true)
    List<Car> testSort(String model, String brand, String fuelType, String tranType, Integer price);
}
